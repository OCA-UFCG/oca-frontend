  ...
  spei: {
    ...
    imageData: {
      general: {
        ...
        imageParams: [
          { color: "#53a7d4", label: "< 5" },
          { color: "#f3d7cb", label: "5 - 8" },
          { color: "#f38657", label: "6 - 8" },
          { color: "#ca0020", label: "8 - 10" },
        ],
      },
    },
    posterUrl:
  ...
  gpp: {
    ...
    imageData: {
      general: {
        ...
        imageParams: [
          { color: "#a50d00", label: "< 5" },
          { color: "#fd9649", label: "5 - 8" },
          { color: "#fedf99", label: "6 - 8" },
          { color: "#12f007", label: "8 - 10" },
          { color: "#125b07", label: "10 - 16" },
